    ...
    <div className="navbar" id="nav">
        ...
        <ul>
          {results.map((result) => (
            <li key={result.id}  onClick={() => {handleInputClick()}}>
              ...
              >
                <img src={UPLOAD_URL + result.profilePic} alt="" />
      ...
      <div className="nav">
        ...
        <div className="right">
          ...
          <div><FaRegUser size={19} title="Account" id="button4"/></div>
          ...
          <Link
            ...
            >
            <div className="user">
              {isLoading? <img src="" alt="" /> : <img src={UPLOAD_URL + data.profilePic} alt="" />}
