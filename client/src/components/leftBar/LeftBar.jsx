...
import { PAGE_URL, UPLOAD_URL } from "../../config";
...
const LeftBar = () => {
  ...
  useEffect(() => {
    ...
    if (leftComponent) { 
      if (window.innerWidth <= 600) {
        leftComponent.style.width = left ? "73px" : "0";
        leftComponent.style.borderRight = left? '0.5px solid #444': "none";
  ...
  useEffect(() => {
    const handleWindowResize = () => {
      ...
      // Change size of leftBar on resize 
        ...
        <div className="menu">
          ...
          >
            <div className="item" title={profile}>
              {pLoading? <img src="" alt="" /> : <img src={UPLOAD_URL + profileData.profilePic} alt="" />}
